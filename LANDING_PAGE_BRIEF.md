...
**What makes it different:** Every recommendation shows *why it fits your inputs* plus a *verification status*. No black-box suggestions. The trust layer is the product wedge.
...
**Priority:** Make the hero + CTA + trust section polished and above the fold. The demo is already functional — the gap is the marketing context that makes a first-time visitor understand *what this is* and *why to try it* before they see the form.
